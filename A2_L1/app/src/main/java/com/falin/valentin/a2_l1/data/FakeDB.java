...
public class FakeDB {
    ...
    public FakeDB() {
        db.add(new Note("Note 1", "Curabitur metus nulla, viverra in ipsum sit amet, placerat vulputate nulla. Pellentesque vitae libero in ipsum egestas egestas. Duis diam velit, bibendum ac libero id, pellentesque interdum est."));
        db.add(new Note("Note 2", "Duis gravida venenatis enim, in luctus dolor tristique id. Donec dignissim erat a dapibus efficitur. Interdum et malesuada fames ac ante ipsum primis in faucibus."));
